...
export const BALANCE_FALLBACK = env("BALANCE", 10000.0);
export const MAX_BET         = env("MAX_BET", 20.0);
export const MIN_EV          = env("MIN_EV", 0.10);
export const MAX_PRICE       = env("MAX_PRICE", 0.45);
export const MIN_VOLUME      = env("MIN_VOLUME", 500);
export const MIN_HOURS       = env("MIN_HOURS", 2.0);
export const MAX_HOURS       = env("MAX_HOURS", 72.0);
export const KELLY_FRACTION  = env("KELLY_FRACTION", 0.25);
export const MAX_SLIPPAGE    = env("MAX_SLIPPAGE", 0.03);
export const SCAN_INTERVAL   = env("SCAN_INTERVAL", 3600);
export const MONITOR_INTERVAL = env("MONITOR_INTERVAL", 600);
export const VC_KEY          = process.env.VC_KEY ?? "";

export const POLY_WALLET     = process.env.POLY_WALLET ?? "";
